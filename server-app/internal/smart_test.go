...
func TestParseSMART(t *testing.T) {
	tests := []struct {
		...
		{name: "WD Blue", data: `{"smartctl":{"exit_status":0},"smart_status":{"passed":true},"temperature":{"current":35},"power_on_time":{"hours":29052},"power_cycle_count":2205,"ata_smart_attributes":{"table":[{"id":4,"name":"Start_Stop_Count","value":94,"raw":{"value":6263}}]}}`, want: smartResult{healthKnown: true, temperature: 35, hours: 29052, cycles: 6263}},
		{name: "health failure retains metrics", data: `{"smartctl":{"exit_status":8},"smart_status":{"passed":false},"temperature":{"current":38},"power_on_time":{"hours":20},"power_cycle_count":1,"ata_smart_attributes":{"table":[{"id":4,"raw":{"value":3}}]}}`, commandErr: errors.New("exit status 8"), want: smartResult{healthKnown: true, temperature: 38, status: 2, hours: 20, cycles: 3}},
		{name: "missing start stop count", data: `{"smart_status":{"passed":true},"power_cycle_count":2205,"ata_smart_attributes":{"table":[{"id":12,"raw":{"value":2205}},{"id":193,"raw":{"value":24209}}]}}`, want: smartResult{healthKnown: true}},
		{name: "zero start stop count", data: `{"smart_status":{"passed":true},"power_cycle_count":10,"ata_smart_attributes":{"table":[{"id":4,"raw":{"value":0}}]}}`, want: smartResult{healthKnown: true}},
		{name: "start stop count saturation", data: `{"smart_status":{"passed":true},"ata_smart_attributes":{"table":[{"id":4,"raw":{"value":4294967296}}]}}`, want: smartResult{healthKnown: true, cycles: 4294967295}},
		...
		{name: "new drive with zero counters", data: `{"smart_status":{"passed":true},"power_on_time":{"hours":0},"power_cycle_count":0}`, want: smartResult{healthKnown: true}},
	}
...
`
	...
	want := smartResult{healthKnown: true, temperature: 35, hours: 29052, cycles: 6263}
