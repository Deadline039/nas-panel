...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_overview_del = true;
    ui->screen_network_del = true;
    ui->screen_storage_del = true;
    ui->screen_sys_info_del = true;
    ui->screen_about_qrcode_del = true;
}
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_screen_overview(ui);
    lv_scr_load(ui->screen_overview);
}
